...
def retriever_context(embeddings_model='nomic-embed-text:v1.5',
...
def retriever_bible(embeddings_model='nomic-embed-text:v1.5',
                     path_books='./vector-store/faiss/bible',
                     distance_metric='cos',
                     fetch_k=100,
                     k=3,
                     maximal_marginal_relevance=False,
